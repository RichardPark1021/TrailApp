        ...
        return (
            <section id="exercises" className="container mt-5">
                ...
                <p className='text-center'>
                    Welcome to the Proper Walking Techniques Library! Learn the best practices to enhance your walking performance.
                </p>
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        {categories[category].map((video, index) => (
                                            <div className="col-md-6 my-4" key={video._id}> {/* Each video in a 2-column layout */}
                                                <div className="card">
                                                    <div className="card-body">
